...
const Login = () => {
    ...
    <div className={`flex min-h-screen flex-col items-center justify-center w-96 mx-auto`}>
 			<div className='w-full p-6 rounded-lg shadow-md text-white bg-gray-800/60 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-20'>
				<h className='text-3xl font-semibold text-center text-gray-300'>
					Login
					<span className='text-purple-200'> YogVeda </span>
				</h>
				<form onSubmit={handleSubmit}>
					...
					<div>
						...
						<input
						 ...
						 type='text' placeholder='Enter username' className='w-full border  px-5 rounded bg-surface-a20/60 h-10' />
					</div>
					<div>
						...
						<input
							...
							className='border w-full px-5 rounded bg-surface-a20/60 h-10'
						/>
					</div>
					</div>
					<Link to={'/signup'} className='text-sm  hover:underline hover:text-primary-a30 mt-2 inline-block'>
